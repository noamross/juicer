...
[![codecov.io](https://codecov.io/github/noamross/juicer/coverage.svg?branch=master)](https://codecov.io/github/noamross/juicer?branch=master)

**juicer** is a small wrapper around the **[juice](https://github.com/Automattic/juice)**
...
that can be sent via e-mail or uploaded to Google Docs with styles intact.
...
The package has one function, `juice()`, which inlines the styles of HTML
passed to it as a string, file, or URL:
